package com.charpixel.baseandroidproject.Modules.RegistrationModule;
...
//        setSupportActionBar(toolbar);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new LoginActivityFragment(), "Login");
        adapter.addFragment(new RegisterFragment(), "Register new");
